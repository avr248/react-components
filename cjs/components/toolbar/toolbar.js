...
var _excluded = ["children", "className", "fixed", "transparent", "color", "active", "size"];
...
var Toolbar = function Toolbar(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!html.classList.contains("has-toolbar-fixed-".concat(fixed))) {
      html.classList.remove('has-toolbar-fixed-top');
      html.classList.remove('has-toolbar-fixed-bottom');
    }

    if (fixed) {
      html.classList.add("has-toolbar-fixed-".concat(fixed));
    }

    return function () {
      return window.document.querySelector('html').classList.remove("has-toolbar-fixed-".concat(fixed));
    };
  }, [fixed]);
  return /*#__PURE__*/_react["default"].createElement(_context.ShowContext.Provider, {
    ...
    role: "navigation",
    className: (0, _classnames2["default"])('toolbar', className, (_classnames = {
...
Toolbar.Brand = _brand["default"];
Toolbar.Burger = _burger["default"];
Toolbar.Menu = _menu["default"];
Toolbar.Item = _item["default"];
Toolbar.Dropdown = _dropdown["default"];
Toolbar.Link = _link["default"];
Toolbar.Divider = _divider["default"];
Toolbar.Container = _container["default"];
