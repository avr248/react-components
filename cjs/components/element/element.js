...
exports.useElementClassNames = exports["default"] = void 0;
...
var _excluded = ["textColor", "backgroundColor", "colorVariant", "flexDirection", "flexWrap", "justifyContent", "alignContent", "alignItems", "flexGrow", "ratio", "clearfix", "paddingless", "pull", "marginless", "overlay", "clipped", "radiusless", "shadowless", "unselectable", "invisible", "clickable", "srOnly", "display", "m", "mt", "mr", "mb", "ml", "mx", "my", "p", "pt", "pr", "pb", "pl", "px", "py", "textWeight", "textTransform", "italic", "textSize", "textAlign", "textFamily", "mobile", "tablet", "desktop", "widescreen", "fullhd", "touch", "untilWidescreen", "untilFullhd"],
    _excluded2 = ["className", "renderAs", "domRef", "children"];
...
var Element = function Element(_ref3) {
  var className = _ref3.className,
      ...
      allProps = _objectWithoutProperties(_ref3, _excluded2);
